...
Blockly.Arduino.grove_led = function() {
  ...
  var code = 'digitalWrite('+dropdown_pin+','+dropdown_stat+'); /// ecrire sur le port gnagna ... dede\n';
  return code;
};
...
Blockly.Arduino.grove_lcd_rgb = function() {
var dropdown_pin = this.getFieldValue('PIN');
  ...
  Blockly.Arduino.definitions_['define_seriallcd'] = '#include <Wire.h>\n';
  Blockly.Arduino.definitions_['define_softwareserial'] = '#include "rgb_lcd.h"\n';
  Blockly.Arduino.definitions_['define_obj'] = 'rgb_lcd lcd;\n';
  //generate PIN#+1 port
  var NextPIN = _get_next_pin(dropdown_pin);


  Blockly.Arduino.setups_['setup_lcd_'+dropdown_pin] = 'lcd.begin(16, 2);\n'; // lcd.setCursor(0, 0);
